addLayer("MS", {
    ...
    update(diff){
        ...
        if(hasUpgrade('MS',54))   player.MS.xb= player.MS.xb.plus(player.MS.xbgain.times(player.M.points.add(1).pow(1.25)).times(player.O.points.add(1).log(10).add(1)).times(player.N.points.add(1).log(10).add(1).log(10).add(1).log(10).add(1)).times(0.05)) 
        if(hasUpgrade('MS',53))   player.MS.xb= player.MS.xb.plus(player.MS.xbgain.times(player.M.points.add(1).pow(1.25)).times(player.O.points.add(1).log(10).add(1)).times(0.05)) 
        else if(hasUpgrade('MS',52))   player.MS.xb= player.MS.xb.plus(player.MS.xbgain.times(player.M.points.add(1).pow(1.25)).times(0.05))
        else if(hasUpgrade('MS',51)) player.MS.xb= player.MS.xb.plus(player.MS.xbgain.times(0.05))
