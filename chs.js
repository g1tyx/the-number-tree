...
var cnItems = {
    ...
    "Number gain ^1.14. However, remove upgrade factor layer (You can't get UF, but their challenge and upgrade won't reset.)": "数字增益 ^1.14。但是，删除升级因素层（您无法获得UF，但他们的挑战和升级不会重置。）",
    "Ordinal": "序数",
    ...
    "Unlock a new prime factor, keep challenge point and upgrade point on reset.": "解锁一个新的主要因素，在重置时保持挑战点和升级点。",
    ...
    "Upgrade Factors are cheaper and you can buy max it.": "升级因素更便宜，您可以购买最多。",
    "Upgrade factors are cheaper.": "升级因素更便宜。",
    "Which make Number Gain ^3,922": "这使得数字增益 ^3,922",
    "You can complete ω 1000 times.": "你可以完成 ω 1000 次。",
    "You have 0 Factors": "你有 0 个因素",
