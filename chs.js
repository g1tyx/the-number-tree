...
var cnItems = {
    ...
    "Unlock 1 Number Upgrade and Remove the hardcap of -2.": "解锁 1 个号码升级并移除 -2 的硬上限。",
    ...
    "IP upgrade 43 has no effect but Number gain ^3.": "IP 升级 43 没有效果，但号码增益 ^3。",
    ...
    "Next layer at complete Boost or nerf 4.": "完成 Boost 或 nerf 4 的下一层。",
    "Rabbit (Easter Egg 3)": "兔子（复活节彩蛋 3）",
    "Reality 1": "现实 1",
    "Reality 2": "现实2",
    "Remove the hardcap of -2 but nerf it.": "移除 -2 的硬帽，但削弱它。",
    "Remove the hardcap of -4 but nerf it and nerf IP gain.": "移除 -4 的硬帽，但削弱它并削弱 IP 增益。",
    ...
    "Unlock 1 Factor Upgrade.": "解锁 1 个因素升级。",
    ...
    "Auto buy Number upgrade and Factor Upgrade and Number, points x1e20, FS reset nothing and Unlock 1 IC.": "自动购买号码升级和因素升级和号码，点数x1e20，FS重置没有和解锁1个IC。",
    ...
    "Boost game speed based on your Factor.": "根据您的因素提高游戏速度。",
    ...
    "Keep IP milestone 4, F milestone 4, 16 and UF milestone 6 and 7 on reset. IP gain ^1.1. Remove the hardcap of NN gain.": "保留 IP 里程碑 4、F 里程碑 4、16 和 UF 里程碑 6 和 7 处于重置状态。 知识产权增益 ^1.1。 移除 NN 增益的硬帽。",
    ...
    "Unlock 1 Number Upgrade.": "解锁 1 个号码升级。",
